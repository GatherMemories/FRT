    ...
    public ProcessingResult deleteExecute() {
        try {
            ...
            if (!hasFilesToDelete(deleteTree)) {
                System.out.println("ℹ️  删除目录中没有文件需要处理");
            ...
            System.out.println();
            System.out.println("📄 文件数量: " + countFiles(deleteTree));
                ...
                if (backupSuccess) {
                    ...
                    if (processingResult.getErrorCount() > 0 && processingResult.getSuccessCount() > 0) {
                        ...
                        if (choice.equals("y") || choice.equals("yes")) {
                            ...
                            System.out.println("ℹ️  用户取消恢复操作");
                        }
                    }

                } else {
                    System.err.println("❌ 备份操作文件失败！");
                }
            }
